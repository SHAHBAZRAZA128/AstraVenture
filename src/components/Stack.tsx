...
export default function Stack() {
  ...
  return (
    <section id="stack" className="py-32 px-6 md:px-12 bg-navy text-offwhite relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-copper/[0.03] rounded-full blur-3xl transform translate-x-1/3 -translate-y-1/3 pointer-events-none"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-32">
          ...
          >
            <p className="text-copper font-bold tracking-widest uppercase mb-6 flex items-center">
              <span className="w-8 h-[2px] bg-copper mr-4"></span> How We Operate
            </p>
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-8 leading-[1.1] tracking-tight">
              We invest in AI.<br/>We run on AI.
            </h2>
            
            <div className="text-xl text-offwhite/70 space-y-6 leading-relaxed mb-12 font-medium">
              <p>
            ...
            <p className="text-sm text-offwhite/50 mt-6 max-w-sm font-medium">
